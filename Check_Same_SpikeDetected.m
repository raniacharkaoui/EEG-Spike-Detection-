% This function counts the number of channels that detect the same spikes between a very small time interval 
% (i.e nb_min_same_spike).
% If the spike is detected nb_min_same_spike times on the channels then it's considered to be a 'true' spike
