...
handles.ch(43) = uicontrol(h1,'Style', 'checkbox',...
                        'Units','normalized',...
                        'Position',[0.85 0.25 0.5 0.05],...
                        'String','P4-T6',...
                        'callback',@getButton43,...
                        'tag','P4T6');
                    
handles.ch(44) = uicontrol(h1,'Style', 'checkbox',...
                        'Units','normalized',...
                        'Position',[0.85 0.2 0.5 0.05],...
                        'String','T6-T10',...
                        'callback',@getButton44,...
                        'tag','T6T10');
                    
handles.ch(45) = uicontrol(h1,'Style', 'checkbox',...
                        'Units','normalized',...
                        'Position',[0.85 0.15 0.5 0.05],...
                        'String','P10-O2',...
                        'callback',@getButton45,...
                        'tag','P10O2'); 
                    
handles.ch(46) = uicontrol(h1,'Style', 'checkbox',...
                        'Units','normalized',...
                        'Position',[0.85 0.1 0.5 0.05],...
                        'String','P10-O2',...
                        'callback',@getButton46,...
                        'tag','P10O2');
...
function selectAll(obj, event)
    ...
    if isa(fileName,'double') % If there is no file selected
        ...
        if selectV == 1
            ...
            channel(45,:) = Get_Channel(path,fileName,'FP1',fileData);
            channel(46,:) = Get_Channel(path,fileName,'FP2',fileData);
            channel(47,:) = [Get_Channel(path,fileName,'F9',fileData) ' '];
            channel(48,:) = Get_Channel(path,fileName,'FP1',fileData);
            channel(49,:) = [Get_Channel(path,fileName,'F9',fileData) ' '];
            channel(50,:) = [Get_Channel(path,fileName,'F7',fileData) ' '];
            channel(51,:) = [Get_Channel(path,fileName,'F7',fileData) ' '];
            channel(52,:) = [Get_Channel(path,fileName,'F3',fileData) ' '];
            channel(53,:) = [Get_Channel(path,fileName,'F3',fileData) ' '];
            channel(54,:) = [Get_Channel(path,fileName,'Fz',fileData) ' '];
            channel(55,:) = [Get_Channel(path,fileName,'Fz',fileData) ' '];
            channel(56,:) = [Get_Channel(path,fileName,'F4',fileData) ' '];
            channel(57,:) = [Get_Channel(path,fileName,'T9',fileData) ' '];
            channel(58,:) = [Get_Channel(path,fileName,'T3',fileData) ' '];
            channel(59,:) = [Get_Channel(path,fileName,'T3',fileData) ' '];
            channel(60,:) = [Get_Channel(path,fileName,'C3',fileData) ' '];
            channel(61,:) = [Get_Channel(path,fileName,'C3',fileData) ' '];
            channel(62,:) = [Get_Channel(path,fileName,'Cz',fileData) ' '];
            channel(63,:) = [Get_Channel(path,fileName,'Cz',fileData) ' '];
            channel(64,:) = [Get_Channel(path,fileName,'C4',fileData) ' '];
            channel(65,:) = [Get_Channel(path,fileName,'C4',fileData) ' '];
            channel(66,:) = [Get_Channel(path,fileName,'T4',fileData) ' '];
            channel(67,:) = [Get_Channel(path,fileName,'T4',fileData) ' '];
            channel(68,:) = Get_Channel(path,fileName,'T10',fileData);
            channel(69,:) = [Get_Channel(path,fileName,'P9',fileData) ' '];
            channel(70,:) = [Get_Channel(path,fileName,'O1',fileData) ' '];
            channel(71,:) = [Get_Channel(path,fileName,'P9',fileData) ' '];
            channel(72,:) = [Get_Channel(path,fileName,'T5',fileData) ' '];
            channel(73,:) = [Get_Channel(path,fileName,'T5',fileData) ' '];
            channel(74,:) = [Get_Channel(path,fileName,'P3',fileData) ' '];
            channel(75,:) = [Get_Channel(path,fileName,'P3',fileData) ' '];
            channel(76,:) = [Get_Channel(path,fileName,'Pz',fileData) ' '];
            channel(77,:) = [Get_Channel(path,fileName,'Pz',fileData) ' '];
            channel(77,:) = [Get_Channel(path,fileName,'P4',fileData) ' '];
            channel(78,:) = [Get_Channel(path,fileName,'P4',fileData) ' '];
            channel(79,:) = [Get_Channel(path,fileName,'T6',fileData) ' '];
            channel(80,:) = [Get_Channel(path,fileName,'T6',fileData) ' '];
            channel(81,:) = [Get_Channel(path,fileName,'T6',fileData) ' '];
            channel(82,:) = Get_Channel(path,fileName,'P10',fileData);
            channel(83,:) = [Get_Channel(path,fileName,'O2',fileData) ' '];
            channel(84,:) = Get_Channel(path,fileName,'P10',fileData);
            channel(85,:) = [Get_Channel(path,fileName,'O1',fileData) ' '];
            channel(86,:) = [Get_Channel(path,fileName,'O2',fileData) ' '];
            ...
            for i=1:86 %List of nrElectrodeRight
...
function preselectAll()
    ...
    if isa(fileName,'double') % If there is no file selected
        ...
        channel(86,:) = [Get_Channel(path,fileName,'O2',fileData) ' '];
        channel = char(channel);
        for i=1:86 %List of nrElectrodeLeft
            if i==1
                nrElectrodeLeft{i} = char(channel(i,:));
            else
                nrElectrodeLeft{end+1} = char(channel(i,:));
...
function getButton24(obj,event)
    ...
    if isa(fileName,'double') % If there is no file selected
        ...
        %% When the button is checked
        if value == 1
            if strcmp(Fct,'F9-Fp1') ==1
                channel37 = Get_Channel(path,fileName,'F9',fileData);
                channel1 = Get_Channel(path,fileName,'Fp1',fileData);
                nrElectrodeLeft{end+1} = [channel37 ' '];
                nrElectrodeLeft{end+2} = [channel1 ' '];
                nrElectrodeRight{end+1} = [channel1 ' '];
                nrElectrodeRight{end+2} = [channel37 ' '];
                nrElectrodeLeft = nrElectrodeLeft(~cellfun(@isempty,nrElectrodeLeft));
                nrElectrodeRight = nrElectrodeRight(~cellfun(@isempty,nrElectrodeRight));
            end
        ...
        if value == 0
           if strcmp(Fct,'F9-Fp1') ==1
                ...
                channel1 = Get_Channel(path,fileName,'Fp1',fileData);
                for i=1:length(nrElectrodeLeft)
                    if (isequal(nrElectrodeLeft{i}, [channel37 ' ']) && isequal(nrElectrodeRight{i}, [channel1 ' '])) || (isequal(nrElectrodeLeft{i}, [channe37 ' ']) && isequal(nrElectrodeRight{i}, [channel1 ' ']))
                        nrElectrodeLeft{i} = {};
                        nrElectrodeRight{i} = {};
                    end
                end 
    ...
    if isa(fileName,'double') % If there is no file selected
        ...
        if value == 0
           if strcmp(Fct,'Fp2-F10') ==1
                ...
                channel41 = Get_Channel(path,fileName,'F10',fileData);
                for i=1:length(nrElectrodeLeft)
                    if (isequal(nrElectrodeLeft{i}, [channel9 ' ']) && isequal(nrElectrodeRight{i}, [channel41 ' '])) || (isequal(nrElectrodeLeft{i}, [channel41 ' ']) && isequal(nrElectrodeRight{i}, [channel9 ' ']))
                        nrElectrodeLeft{i} = {};
                        nrElectrodeRight{i} = {};
                    end
                end 
...
function getButton38(obj,event)
    ...
    if isa(fileName,'double') % If there is no file selected
        ...
        %% When the button is checked
        if value == 1
            if strcmp(Fct,'P9-O1') ==1
                channel69 = Get_Channel(path,fileName,'P9',fileData);
                channel70 = Get_Channel(path,fileName,'O1',fileData);
                nrElectrodeLeft{end+1} = [channel69 ' '];
                nrElectrodeLeft{end+2} = [channel70 ' '];
                nrElectrodeRight{end+1} = [channel70 ' '];
                nrElectrodeRight{end+2} = [channel69 ' '];
                nrElectrodeLeft = nrElectrodeLeft(~cellfun(@isempty,nrElectrodeLeft));
                nrElectrodeRight = nrElectrodeRight(~cellfun(@isempty,nrElectrodeRight));
            end
        end
        ...
        if value == 0
           if strcmp(Fct,'P9-O1') ==1
                ...
                channel70 = Get_Channel(path,fileName,'O1',fileData);
                for i=1:length(nrElectrodeLeft)
                    if (isequal(nrElectrodeLeft{i}, [channel69 ' ']) && isequal(nrElectrodeRight{i}, [channel70 ' '])) || (isequal(nrElectrodeLeft{i}, [channel70 ' ']) && isequal(nrElectrodeRight{i}, [channel69 ' ']))
                        nrElectrodeLeft{i} = {};
                        nrElectrodeRight{i} = {};
                    end
                end 
...
%% 
function getButton43(obj,event)
    data=guidata(gcbf);
    Fct = get(obj,'String');
    value = get(obj,'Value');
    fileData = getappdata(gcbf,'fileData');
...
%% 
function getButton44(obj,event)
    data=guidata(gcbf);
    Fct = get(obj,'String');
    value = get(obj,'Value');
    fileData = getappdata(gcbf,'fileData');
    ...
    if isa(fileName,'double') % If there is no file selected
        ...
        %% When the button is checked
        if value == 1
            if strcmp(Fct,'T6-T10') ==1
                channel81 = Get_Channel(path,fileName,'T6',fileData);
                channel82 = Get_Channel(path,fileName,'T10',fileData);
...
function getButton45(obj,event)
    data=guidata(gcbf);
    Fct = get(obj,'String');
    value = get(obj,'Value');
    fileData = getappdata(gcbf,'fileData');
    ...
    if isa(fileName,'double') % If there is no file selected
        ...
        %% When the button is checked
        if value == 1
            if strcmp(Fct,'P10-02') ==1
                channel84 = Get_Channel(path,fileName,'P10',fileData);
                channel83 = Get_Channel(path,fileName,'O2',fileData);
                nrElectrodeLeft{end+1} = [channel84 ' '];
                nrElectrodeLeft{end+2} = [channel83 ' '];
                nrElectrodeRight{end+1} = [channel83 ' '];
                nrElectrodeRight{end+2} = [channel84 ' '];
                nrElectrodeLeft = nrElectrodeLeft(~cellfun(@isempty,nrElectrodeLeft));
                nrElectrodeRight = nrElectrodeRight(~cellfun(@isempty,nrElectrodeRight));
            end
        end
        %%  When the button is unchecked
        if value == 0
           if strcmp(Fct,'P10-O2') ==1
                channel84 = Get_Channel(path,fileName,'P10',fileData);
                channel83 = Get_Channel(path,fileName,'O2',fileData);
                for i=1:length(nrElectrodeLeft)
                    if (isequal(nrElectrodeLeft{i}, [channel84 ' ']) && isequal(nrElectrodeRight{i}, [channel83 ' '])) || (isequal(nrElectrodeLeft{i}, [channel83 ' ']) && isequal(nrElectrodeRight{i}, [channel84 ' ']))
                        nrElectrodeLeft{i} = {};
                        nrElectrodeRight{i} = {};
                    end
                end 
...
%% 
function getButton46(obj,event)
    data=guidata(gcbf);
    Fct = get(obj,'String');
    value = get(obj,'Value');
    fileData = getappdata(gcbf,'fileData');
    ...
    if isa(fileName,'double') % If there is no file selected
        ...
        %% When the button is checked
        if value == 1
            if strcmp(Fct,'O2-O1') ==1
                channel86 = Get_Channel(path,fileName,'O2',fileData);
                channel85 = Get_Channel(path,fileName,'O1',fileData);
