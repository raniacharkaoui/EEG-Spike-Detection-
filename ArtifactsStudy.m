...
function [] = ArtifactsStudy(file,CurrentRecording,MuscleArtifactsTimeIn,MuscleArtifactsTimeOut)
    ...
    for Derivation=1:NumDerivation
        ...
        % timings, you delete for example the muscular artifacts from all of
        % them. The cardiac are detected only if the patient is AG and they
        % are deleted them in the specific derivation in the spike detector.
