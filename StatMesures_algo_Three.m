function [Real_Sensitivity,Real_Precision,Real_PearsonCoef] = StatMesures_algo_Three(ExpA_timeIn, ExpA_timeOut,ExpB_timeIn,ExpB_timeOut,ExpC_timeIn,ExpC_timeOut, algo_timeIn,algo_timeOut)
